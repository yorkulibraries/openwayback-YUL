...
<div id="wm-disclaim" dir="ltr" >
	<table width="100%" border="0" cellpadding="0" cellspacing="3">
		<tr>
			<!-- OPENWAYBACK LOGO -->
			<td rowspan="2" valign="top" align="left"><a href="<%= queryPrefix %>"><img style="padding-right:15px;" src="<%= staticPrefix %>images/YorkULogo_Hor_rgb-bootstrap_transparent.png" border="0"></a></td>
			<!-- /OPENWAYBACK LOGO -->
			<td width="99%">
